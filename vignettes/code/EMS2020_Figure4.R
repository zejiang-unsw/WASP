...
Grid = c(45,117,142,149) # run with sampled grids
...
#------------------------------------------------------------------------------
#save file
save(sel.cv, file=paste0("./result/data.SPI.",sc,".selection_",mode,"_",wf,"_",k.folds,"folds.sample.Rdata"))
save(wt.cv, file=paste0("./result/data.SPI.",sc,".weights_",mode,"_",wf,"_",k.folds,"folds.sample.Rdata"))
save(data.SPI.mod, file=paste0("./result/data.SPI.",sc,".mod_",mode,"_",wf,"_",k.folds,"folds.sample.Rdata"))
save(data.SPI.ref, file=paste0("./result/data.SPI.",sc,".ref_",mode,"_",wf,"_",k.folds,"folds.sample.Rdata"))
