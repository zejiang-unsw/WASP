...
flag = switch(2, "biased", "unbiased")
detrend = F
flag.level <- switch(2, "biased", "unbiased")
...
#------------------------------------------------------------------------------
#save file
#save(sel.cv, file=paste0("./result/data.SPI.unbiased.",sc,".selection_",mode,"_",wf,"_",k.folds,"folds.Rdata"))
#save(wt.cv,  file=paste0("./result/data.SPI.unbiased.",sc,".weights_",mode,"_",wf,"_",k.folds,"folds.Rdata"))
save(data.SPI.mod, file=paste0("./result/data.SPI.unbiased.",sc,".mod_",mode,"_",wf,"_",k.folds,"folds.Rdata"))
#save(data.SPI.ref, file=paste0("./result/data.SPI.unbiased.",sc,".ref_",mode,"_",wf,"_",k.folds,"folds.Rdata"))
